package com.challengen.alura.forohub.controller;

import com.challengen.alura.forohub.domain.curso.Curso;
import com.challengen.alura.forohub.domain.curso.repository.CursoRepository;
import com.challengen.alura.forohub.domain.respuesta.Respuesta;
import com.challengen.alura.forohub.domain.respuesta.dto.DetalleRespuestaDTO;
...
import com.challengen.alura.forohub.domain.topico.Topico;
import com.challengen.alura.forohub.domain.topico.dto.ActualizarTopicoDTO;
import com.challengen.alura.forohub.domain.topico.dto.CrearTopicoDTO;
import com.challengen.alura.forohub.domain.topico.dto.DetallesTopicoDTO;
import com.challengen.alura.forohub.domain.topico.repository.TopicoRepository;
import com.challengen.alura.forohub.domain.topico.validations.create.ValidarTopicoCreado;
import com.challengen.alura.forohub.domain.topico.validations.update.ValidarTopicoActualizado;
import com.challengen.alura.forohub.domain.usuario.Usuario;
import com.challengen.alura.forohub.domain.usuario.repository.UsuarioRepository;
