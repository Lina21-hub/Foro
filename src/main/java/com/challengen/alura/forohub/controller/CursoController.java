...
import com.challengen.alura.forohub.domain.curso.dto.ActualizarCursoDTO;
import com.challengen.alura.forohub.domain.curso.dto.CrearCursoDTO;
import com.challengen.alura.forohub.domain.curso.dto.DetalleCursoDTO;
...
@Tag(name = "Curso", description = "Puede pertener a una de las muchas categorias definidas")
